...
void main(void) {
    ...
    gl_FragColor = vec4(blendScreen(blendNormal(sourceColor.rgb, blendMultiply(uColorAbsorb,uAmbient,.9), uDensity * uAbsorbDensity), blendMultiply(uColorScatter,uAmbient,1.), uDensity)*sourceColor.a, sourceColor.a);
}
